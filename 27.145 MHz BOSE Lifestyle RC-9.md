...
However, it generates many other frequencies as well, so this is not a clean solution. Also, the sender with a 30 cm long wire as an antenna on pin RX must be placed next to the music center.
